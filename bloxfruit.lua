if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    _G.Color = Color3.fromRGB(0,179,255)
    ...
    function library:AddWindow(text,keybind)
        ...
        User.Name = "User"
        User.Parent = Page
        User.BackgroundColor3 = Color3.fromRGB(43, 0, 255)
        ...
        UserText.BackgroundColor3 = Color3.fromRGB(43, 0, 255)
        ...
        UserImage.BackgroundColor3 = Color3.fromRGB(43, 0, 255)
        ...
        function uitab:AddTab(text,image)
            ...
            PageButton.MouseButton1Click:Connect(function()
                ...
                for i,v in next, ScrollPage:GetChildren() do 
                    ...
                    TweenService:Create(
                        PageButton,
                        TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
                        {TextColor3 = Color3.fromRGB(55,6,255)}
                    ):Play()
                end
            end)
            ...
            function main:AddToggle(text,config,callback)
                ...
                ToggleImage2.BackgroundColor3 = Color3.fromRGB(55,6,255)
            ...
            function main:AddSlider(text,min,max,set,callback)
                ...
                Bar.Name = "Bar"
                Bar.Parent = Bar1
                Bar.BackgroundColor3 = Color3.fromRGB(55,6,255)
            ...
            function main:AddSeperator(text)
                ...
                Sep1.BackgroundColor3 = Color3.fromRGB(55,6,255)
                ...
                Sep2.BackgroundColor3 = Color3.fromRGB(55,6,255)
            ...
            function main:AddLine()
                ...
                Linee.Name = "Linee"
                Linee.Parent = Line
                Linee.BackgroundColor3 = Color3.fromRGB(55,6,255)
    ...
    --------------------------------------------------------------------
    local RTNUi = library:AddWindow("RTN Hub | BF",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    local Main = RTNUi:AddTab("Auto Farm","6026568198")
    local Combat = RTNUi:AddTab("Combat","7251993295")
    local Stats = RTNUi:AddTab("Stats","7040410130")
    local Teleport = RTNUi:AddTab("Teleport","6035190846")
    local Dungeon = RTNUi:AddTab("Dungeon","7044284832")
    local DevilFruit = RTNUi:AddTab("Devil Fruit","7044233235")
    local Shop = RTNUi:AddTab("Shop","6031265976")
    local Misc = RTNUi:AddTab("Misc","6034509993")
    --------------------------------------------------------------------
...
elseif game.PlaceId == 4520749081 or game.PlaceId == 6381829480 or game.PlaceId == 5931540094 or game.PlaceId == 5931540094 then
    _G.Color = Color3.fromRGB(55,6,255)
    if not game:IsLoaded() then repeat game.Loaded:Wait() until game:IsLoaded() end
    ...
    --
    local RTNUi = library:AddWindow("Ren Hub | KL",Enum.KeyCode.RightControl)
    --
    local Main = RTNUi:AddTab("Auto Farm","6026568198")
    local Stats = RTNUi:AddTab("Stats","7040410130")
    local Combat = RTNUi:AddTab("Combat","7251993295")
    local Teleport = RTNUi:AddTab("Teleport","7044226690")
    local Dungeon = RTNUi:AddTab("Dungeon","7044284832")
    local Misc = RTNUi:AddTab("Misc","6034900727")
    local Settings = RTNUi:AddTab("Settings","6034509993")
    --
    Main:AddSeperator("Settings")
...
elseif game.PlaceId == 6329844902 then
    ...
    --
    local RTNUi = library:AddWindow("Ren Hub | LP",Enum.KeyCode.RightControl)
    --
    local Main = RTNUi:AddTab("Auto Farm","6026568198")
    local Stats = RTNUi:AddTab("Stats","7040410130")
    local Combat = RTNUi:AddTab("Combat","7251993295")
...
function loading()
    ...
    Background.Image = "http://www.roblox.com/asset/?id=9288562509"
    ...
    LoadingProgress.Image = "rbxassetid://9288562509"
